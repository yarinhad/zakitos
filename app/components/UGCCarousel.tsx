...
const MOCK_UGC: UGCPost[] = [
  {
    id: '1',
    username: 'heatseeker.alex',
    handle: '@heatseeker.alex',
    avatar: '/zakitos-logo.png',
    image: '/lifestyle-desert-roadtrip.png',
    caption: "Not for the faint-hearted. Are you brave enough? #ZakitosChallenge",
    likes: 4821,
  ...
  },
  {
    ...
    handle: '@mikeh_eats',
    avatar: '/zakitos-logo.png',
    image: '/lifestyle-kitchen.png',
    caption: 'Cannot stop. Send help.',
    likes: 2340,
  ...
  {
    id: '3',
    username: 'partywithpeppers',
    handle: '@partywithpeppers',
    avatar: '/zakitos-logo.png',
    image: '/lifestyle-bbq-party.png',
    caption: 'BBQ hit different with Zakitos on the table 🔥',
    likes: 3987,
  ...
  {
    id: '4',
    username: 'gamerfuel.real',
    handle: '@gamerfuel.real',
    avatar: '/zakitos-logo.png',
  ...
  {
    id: '5',
    username: 'cozyandspicy',
    handle: '@cozyandspicy',
    avatar: '/zakitos-logo.png',
    image: '/lifestyle-cozy-window.png',
    caption: 'Rainy day + Zakitos = the only combo that matters.',
    likes: 5431,
  ...
  {
    id: '6',
    username: 'squad.snacks',
    handle: '@squad.snacks',
    avatar: '/zakitos-logo.png',
    image: '/lifestyle-friends-snacking.png',
    caption: 'Game night just got spicier. No regrets.',
    likes: 6230,
    heatReaction: 'Iconic',
    platform: 'instagram',
  },
